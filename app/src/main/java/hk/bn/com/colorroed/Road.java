...
public class Road
{
    ...
    public Road(MySurfaceView mv,float x0,float x1,float y0,float y1,float z0)
    {    	
    	//初始化顶点坐标与着色数据
    ...
    public void initVertexData(float x0,float x1,float y0,float y1,float z0)
    {
        ...
        for (int i = 0;i <n; i++) {
           ...
           // System.out.println("x= "+vertices1[count-2]+"  y=  "+vertices1[count-3]+"  z=  "+vertices1[count-1]+"    "+(count-1)+"111111111");
